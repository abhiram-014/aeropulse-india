...
export const DistrictDateSelectorBar: React.FC<DistrictDateSelectorBarProps> = ({
  ...
  return (
    <div className="rounded-3xl glass-panel p-4 sm:p-6 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
        ...
        <div className="relative md:col-span-4">
          ...
          <div className="relative">
            ...
            {showStateDropdown && (
              <div className="absolute z-50 top-full mt-1.5 w-full rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden animate-in fade-in duration-150">
